...
<head>
    ...
    <link rel="stylesheet" href="css/style.css" href="{{asset('admin_assets/css/style.css')}}">
...
<div class="home-slider owl-carousel">
    ...
    <div class="item">
        <img src="{{asset('admin_assets/images/home_img1.jpg')}}" alt="">
        <div class="content">
    ...
    <div class="item">
        <img src="{{asset('admin_assets/images/home_img2.jpg')}}" alt="">
        <div class="content">
    ...
    <div class="item">
        <img src="{{asset('admin_assets/images/home_img3.jpg')}}" alt="">
        <div class="content">
    ...
    <div class="item">
        <img src="{{asset('admin_assets/images/home_img4.jpg')}}" alt="">
        <div class="content">
...
<div class="box-container">
    ...
    <div class="box">
        <div class="image">
            <img src="{{asset('admin_assets/images/arr_img1.jpg')}}" alt="smart TV">
        </div>
        <div class="info">
            <h3>smart tv</h3>
            <div class="subInfo">
    ...
    <div class="box">
        <div class="image">
            <img src="{{asset('admin_assets/images/arr_img2.jpg')}}" alt="">
        </div>
        <div class="info">
            <h3>game console</h3>
            <div class="subInfo">
    ...
    <div class="box">
        <div class="image">
            <img src="{{asset('admin_assets/images/arr_img3.jpg')}}" alt="">
        </div>
        <div class="info">
            <h3>latest shoes</h3>
            <div class="subInfo">
    ...
    <div class="box">
        <div class="image">
            <img src="{{asset('admin_assets/images/arr_img4.jpg')}}" alt="">
        </div>
        <div class="info">
            <h3>smartphones</h3>
            <div class="subInfo">
    ...
    <div class="box">
        <div class="image">
            <img src="{{asset('admin_assets/images/arr_img5.jpg')}}" alt="">
        </div>
        <div class="info">
    ...
    <div class="box">
        <div class="image">
            <img src="{{asset('admin_assets/images/arr_img6.jpg')}}" alt="">
        </div>
        <div class="info">
...
<div class="row">
    ...
    <div class="image-container">
        ...
        <div class="big-image">
            <img src="{{asset('admin_assets/images/watch1.jpg')}}" alt="">
        </div>

        <div class="small_image">
            <img class="image-active" src="images/watch1.png" alt="">
...
<div class="image-container">
    ...
    <div class="box phone">
        <div class="image">
            <img src="{{asset('admin_assets/images/g_img1.jpg')}}" alt="">
        </div>
        <div class="info">
            <h3>smartphones</h3>
            <div class="subInfo">
    ...
    <div class="box phone">
        <div class="image">
            <img src="{{asset('admin_assets/images/g_img2.jpg')}}" alt="">
        </div>
        <div class="info">
            <h3>smartphones</h3>
            <div class="subInfo">
    ...
    <div class="box laptop">
        <div class="image">
            <img src="{{asset('admin_assets/images/g_img3.jpg')}}" alt="">
        </div>
        <div class="info">
            <h3>laptop</h3>
            <div class="subInfo">
    ...
    <div class="box shoes">
        <div class="image">
            <img src="{{asset('admin_assets/images/g-img4.png')}}" alt="">
        </div>
        <div class="info">
            <h3>shoes</h3>
            <div class="subInfo">
    ...
    <div class="box laptop">
        <div class="image">
            <img src="{{asset('admin_assets/images/g_img5.jpg')}}" alt="">
        </div>
        <div class="info">
            <h3>laptop</h3>
            <div class="subInfo">
    ...
    <div class="box headphone">
        <div class="image">
            <img src="{{asset('admin_assets/images/g_img6.png')}}" alt="">
        </div>
        <div class="info">
            <h3>headphone</h3>
            <div class="subInfo">
    ...
    <div class="box shoes">
        <div class="image">
            <img src="{{asset('admin_assets/images/g_img7.png')}}" alt="">
        </div>
        <div class="info">
            <h3>shoes</h3>
            <div class="subInfo">
    ...
    <div class="box headphone">
        <div class="image">
            <img src="{{asset('admin_assets/images/g_img8.jpg')}}" alt="">
        </div>
        <div class="info">
            <h3>headphone</h3>
            <div class="subInfo">
    ...
    <div class="box headphone">
        <div class="image">
            <img src="{{asset('admin_assets/images/g_img9.jpg')}}" alt="">
        </div>
        <div class="info">
            <h3>headphone</h3>
            <div class="subInfo">
...
<div class="box-container">
    ...
    <div class="box">
        <img src="{{asset('admin_assets/images/deal1.jpg')}}" alt="">
        <div class="content">
            <h3>latest laptop</h3>
    ...
    <div class="box">
        <img src="{{asset('admin_assets/images/deal2.jpg')}}" alt="">
        <div class="content">
            <h3>new headphone</h3>
            <p>upto 25% off on first purchase</p>
            <a href="#"><button class="btn">explore</button></a>
...
<!-- custom js file link  -->
<script  src="{{asset('admin_assets/js/usermain.js')}}"></script>
