...
<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <strong>Alert: </strong>{{session('sku_error')}}
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                   ...
                                   @if($loop_count_num==2)
                                   <button type="button" class="btn btn-primary btn-lg" onclick="add_more()"><i class="fa fa-plus"></i>&nbsp;Add</button>
                                   @else
...
<script>
    ...
    function add_more(){
        ...
        html+=' <div class="col-md-4"><label for="image" class="control-label mb-1">Action&nbsp;</label><button type="button" class="btn btn-danger btn-lg" onclick=remove_more("'+loop_count+'")><i class="fa fa-minus"></i>&nbsp;Remove</button></div>';
